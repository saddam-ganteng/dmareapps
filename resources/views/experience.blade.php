        ...
        <div class="col-md-18">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="progress m-4">
                        <div class="progress-bar" role="progressbar" style="width: 69%;" aria-valuenow="25"
                            aria-valuemin="0" aria-valuemax="100">Photoshop</div>
                    </div>
                </div>
            </div>
            <div class="card-deck mt-5" style="width: 600px;">
            <div class="card">
